              ...
              <div className="d-flex flex-column gap-2" style={{ fontSize: '0.85rem' }}>
                <div>
                  ...
                  {profile.documents?.resume ? (
                    <a
                      href={`${import.meta.env.VITE_API_URL || 'http://localhost:https://crmbackend-nq36.onrender.com'}${profile.documents.resume}`}
                      target="_blank"
                ...
                <div className="mt-2">
                  ...
                  {profile.documents?.aadhar ? (
                    <a
                      href={`${import.meta.env.VITE_API_URL || 'http://localhost:https://crmbackend-nq36.onrender.com'}${profile.documents.aadhar}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary text-decoration-none font-weight-medium d-inline-flex align-items-center gap-1 mt-1"
                    >
                ...
                <div className="mt-2">
                  ...
                  {profile.documents?.pan ? (
                    <a
                      href={`${import.meta.env.VITE_API_URL || 'http://localhost:https://crmbackend-nq36.onrender.com'}${profile.documents.pan}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary text-decoration-none font-weight-medium d-inline-flex align-items-center gap-1 mt-1"
                    >
